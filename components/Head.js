...
const defaultTitle = 'Git-Profile';
const defaultDescription =
  'The application displays the nicer look of GitHub profiles built with ReactJS, ChartJS, and the GitHub API';
const defaultOGURL = 'https://github.com/hemantsaini-7/GitProfile-Visualizer';
const defaultOGImage = 'https://github.com/hemantsaini-7/GitProfile-Visualizer';
